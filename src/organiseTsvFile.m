...
% then looks at empty cells and inserts 
 ...
 % add bids repo
  ...
  % raw data path
  rawDir = '/Users/shahzad/Files/fMRI/visTacMotionDir/raw';
  ...
  %this irganisation is for ALL TASKS because - here- rmeoving extra tabs
  taskNames = {'mainExperiment2','tactileLocalizer2','visualLocalizer2'};
